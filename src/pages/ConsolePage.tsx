  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main() {
          float noise = 3.0 * pnoise(vec3(position.xyz * 0.05, u_time * 0.1), vec3(10.0));
      ...
      fragmentShader: `
        ...
        void main() {
          gl_FragColor = vec4(u_red * 0.9 + u_green * 0.1 + u_blue * 0.7, 1.0);
        }
      `,
    });
    ...
    <div data-component="ConsolePage">
      <div className="content-top">
        <div className="content-title">
          ...
          <span><strong>LAIT Thecnology - Agentes de voz</strong></span>
        </div>
      ...
      <div className="content-main">
        ...
        <div ref={threeRef} className="three-container"></div>
